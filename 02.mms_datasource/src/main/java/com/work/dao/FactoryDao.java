 ...
 * 1. private 생성자
 * 2. private static 클래스명 instance = new 클래스명();
 * 3. public static 클래스명 getInstance() { return instance;}
 *
 */
public class FactoryDao {
		/** jdbc resource property
		 * -- 파일로 분리 설계 : java.io.* => 개발자가 직접 구현하면 마음대로 가능
		 * -- java.util.ResourceBundle API	(안할건데 그냥 알려주심)
		 * 		=> 규칙
	 ...
	 * @return Connection
	 * 2일차 front datasource.txt에 있는거 가져온거
	 */
